      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center text-center mb-16 max-w-4xl mx-auto">
          ...
          <h2 className="text-lg md:text-xl text-slate-400 max-w-2xl mb-10 leading-relaxed">
            Stop relying on chance. Implement the automated review gate that guarantees 5-star Google ratings and delivers evergreen video testimonials for your marketing pipeline.
          </h2>
