      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Transparent Pricing. <br/>Unconditional Guarantee.</h2>
            ...
            <div className="bg-emerald-900/10 border border-brand-accent/20 rounded-xl p-6 mb-8">
              <h3 className="flex items-center gap-2 text-brand-accent font-bold mb-2">
                <ShieldCheck /> The Performance Pledge
              </h3>
              <p className="text-sm text-slate-300">
                If you choose to terminate your subscription at any point, you will receive a 100% full refund for the current month's fee, no questions asked.
              </p>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 w-full">
            <div className="relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-transparent">
              <div className="bg-slate-950 rounded-xl p-8 md:p-12 relative overflow-hidden">
                ...
                <h3 className="text-xl font-medium text-slate-400 mb-2">Standard Practice</h3>
